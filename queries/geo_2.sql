...
-- Consulta baseada em geo_ucs.sql, agora filtrando apenas as UCs recebidas do Python.
--
-- Bind esperado:
--   :UCS -> SYS.ODCIVARCHAR2LIST com a lista de UCs.
--
-- Observacao:
--   A normalizacao abaixo remove apenas zeros a esquerda para aceitar, por exemplo,
--   0043313071 e 43313071 como a mesma UC.
